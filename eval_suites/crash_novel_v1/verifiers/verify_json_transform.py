...
This verifier never imports or executes agent-produced Python. It checks that
protected inputs retain their hashes and that the declared JSON output exactly
